...
const HeroSection = (
	{ active, changeTab, sections }: { active: string, changeTab: (tab: string) => void, sections: Section[] }
) => (
	<section
	...
	>
		<div className="flex flex-col h-full w-full space-y-4">
			...
			<div className="border-t border-white/40 w-full pt-1">
				<div className="flex flex-row text-white space-x-3 justify-between md:justify-start px-5 sm:px-10 md:px-16 lg:px-20">
